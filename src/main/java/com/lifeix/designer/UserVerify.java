...
public class UserVerify {
    ...
    public User verify(String userId,String deviceId)throws NotAuthorizedException {
        ...
        if (online==null||online.getDeviceId()==null||!deviceId.equals(online.getDeviceId()))throw new NotAuthorizedException("this account login other deviceid", Response.status(Response.Status.UNAUTHORIZED));
        return user;
    }
